...
namespace NOP
{
    ...
    {
        private class Curry : NOPFunc<TArg2, TRes>
        {
            private NOPFunc<TArg1, TArg2, TRes> _func;
            private TArg1 _arg1;

            public Curry (NOPFunc<TArg1, TArg2, TRes> func, TArg1 arg1)
            {
                _func = func;
                _arg1 = arg1;
            }
    ...
    {
        private class Curry : NOPFunc<TArg2, TArg3, TRes>
        {
            private NOPFunc<TArg1, TArg2, TArg3, TRes> _func;
            private TArg1 _arg1;

            public Curry (NOPFunc<TArg1, TArg2, TArg3, TRes> func, TArg1 arg1)
            {
                _func = func;
                _arg1 = arg1;
            }
    ...
    {
        private class Curry : NOPFunc<TArg2, TArg3, TArg4, TRes>
        {
            private NOPFunc<TArg1, TArg2, TArg3, TArg4, TRes> _func;
            private TArg1 _arg1;

            public Curry (NOPFunc<TArg1, TArg2, TArg3, TArg4, TRes> func, TArg1 arg1)
            {
                _func = func;
                _arg1 = arg1;
            }
